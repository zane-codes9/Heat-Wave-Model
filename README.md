...
Linear models are blind to this wall, this model finds it. We tested this against the 2021 British Columbia Heat Dome (Lytton); the model identified the collapse point just 0.7°C away from the actual peak temperature of the village before it burned down.
