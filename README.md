...
This repository contains the Python code used to map the theoretical tipping points of cities during extreme heat waves. 
...
Linear models are blind to this wall, this dynamic model finds it. We tested this against the 2021 British Columbia Heat Dome (Lytton), and the model identified the collapse point just 0.7°C away from the peak temperature.
...
### How to use
Open the `heat-wave-model.ipynb` file in Google Colab or Jupyter Notebook and run the cells. It simulates the theoretical model and plots the asymptote (the wall) comparing both linear and dynamic outputs.
